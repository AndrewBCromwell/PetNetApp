...
namespace DataAccessLayerFakes
{
    public class FundraisingCampaignAccessorFakes : IFundraisingCampaignAccessor
    {
        ...
        public List<FundraisingCampaign> SelectAllFundraisingCampaignsByShelterId(int shelterId)
        {
            ...
            {
                new FundraisingCampaign(){ ShelterId = 100000,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Garble", Complete=true},
                new FundraisingCampaign(){ ShelterId = 100002,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Garble", Complete=false},
                new FundraisingCampaign(){ ShelterId = 100000,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Garble", Complete=false},
                new FundraisingCampaign(){ ShelterId = 100000,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Garble", Complete=true},
                new FundraisingCampaign(){ ShelterId = 100001,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Garble", Complete=false},
                new FundraisingCampaign(){ ShelterId = 100001,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Garble", Complete=false},
                new FundraisingCampaign(){ ShelterId = 100002,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Garble", Complete=true},
                new FundraisingCampaign(){ ShelterId = 100003,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Garble", Complete=false},
                new FundraisingCampaign(){ ShelterId = 100001,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Garble", Complete=true},
                new FundraisingCampaign(){ ShelterId = 100000,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Garble", Complete=false},
                new FundraisingCampaign(){ ShelterId = 100002,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Garble", Complete=false},
                new FundraisingCampaign(){ ShelterId = 100000,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Garble", Complete=false},
                new FundraisingCampaign(){ ShelterId = 100000,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Garble", Complete=true},
                new FundraisingCampaign(){ ShelterId = 100001,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Goop", Complete=false},
                new FundraisingCampaign(){ ShelterId = 100001,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Goop", Complete=false},
                new FundraisingCampaign(){ ShelterId = 100002,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Goop", Complete=true},
                new FundraisingCampaign(){ ShelterId = 100003,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Goop", Complete=false},
                new FundraisingCampaign(){ ShelterId = 100001,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Goop", Complete=true},
                new FundraisingCampaign(){ ShelterId = 100000,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Goop", Complete=false},
                new FundraisingCampaign(){ ShelterId = 100002,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Goop", Complete=false},
                new FundraisingCampaign(){ ShelterId = 100000,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Goop", Complete=false},
                new FundraisingCampaign(){ ShelterId = 100000,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Goop", Complete=true},
                new FundraisingCampaign(){ ShelterId = 100001,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Goop", Complete=false},
                new FundraisingCampaign(){ ShelterId = 100001,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Goop", Complete=false},
                new FundraisingCampaign(){ ShelterId = 100002,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Goop", Complete=true},
                new FundraisingCampaign(){ ShelterId = 100003,Title="Fundraising Event " + rand.Next(100),StartDate=null, FundraisingCampaignId = fundraisingCampaignId++, Description="Goop", Complete=false},
